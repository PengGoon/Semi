...
<body>
	...
	<div class=sellerJoin>
		...
		<table class=sellerJoinTable>
			...
			<tr>
				<td>아이디 *</td>
				<td><input class="inp" type="text" name="userId"
					placeholder="아이디" /> <input type="button" id="overlay"
					value="아이디 중복 체크" /></td>
			</tr>
			<tr>
				<td>비밀번호 *</td>
			...
			<tr>
				...
				<td><input class=inp type="text" name="addr1"
					...
					<input type="button" id="path" onclick="sample4_execDaumPostcode()"
					value="우편번호 찾기"> <br> <input class=inp type="text"
					name="addr2" id="sample4_roadAddress" placeholder="도로명주소"
					style="margin: 4 0 4 0"> <input class=inp type="text"
					name="addr3" id="sample4_jibunAddress" placeholder="지번주소"
					style="margin: 4 0 4 0"> <span id="guide"
			...
			<tr>
				<td>이메일 *</td>
				<td><input class=inp type="text" name="email" placeholder="이메일"
					style="margin: 0 5 0 0" />@ <input class=inp type="text"
					id="emailview" name="emailview" placeholder="이메일 선택"
					style="width: 150" disabled="true" /> <select id="email">
			...
			<tr>
				...
				<td><input class="inp" type="text" name="phone"
					placeholder="휴대전화 번호" /></td>
			</tr>
			<tr>
				<td>사업자 등록증 *</td>
				<td><input class="inp" type="text" id="successinfo"
					name="successinfo" style="color: green" placeholder="사업자 등록증 등록란"
					disabled="true" /> <input type="button" id="upload"
					onclick="openChild()" value="업로드" />
			</tr>
			...
			<tr>
				<td colspan="3">
					<button class=button id="join">회원가입</button> <a class=exit
					onclick=" location.href='userLogin.jsp' ">나가기</a>
				</td>
			</tr>
		</table>
		<br /> <br /> <br />
